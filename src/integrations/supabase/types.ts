...
export type Database = {
  public: {
    Tables: {
      ...
      requirement_brd: {
        Row: {
          ai_signoff_confidence: number | null
          approver_comment: string | null
          approver_name: string | null
          brd_document: Json | null
          business_goals: string | null
          created_at: string | null
          edge_tests: number | null
          final_recommendation: string | null
          functional_tests: number | null
          id: string
          integration_tests: number | null
          key_features: string | null
          market_research_summary: string | null
          negative_tests: number | null
          problem_statement: string | null
          project_overview: string | null
          proposed_solution: string | null
          requirement_id: string | null
          ...
          updated_at: string | null
          use_cases_summary: string[] | null
          user_stories_summary: string[] | null
    ...
    Functions: {
      ...
      complete_case_generator: {
        Args: { req_id: string }
        Returns: undefined
      }
      complete_market_sense: {
        Args: { req_id: string }
        Returns: undefined
      }
      complete_requirement_capture: {
        Args: { req_id: string }
        Returns: boolean
      }
      complete_validator: {
