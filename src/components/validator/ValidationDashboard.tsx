  ...
  return (
    <div
      className={
        hideMetrics
          ? ""
          : "min-h-screen bg-gradient-to-br from-slate-100 via-white to-indigo-100 animate-gradient-x p-6"
      }
    >
      {!hideMetrics && (
        <>
          <div className="mb-8">
            ...
            <p className="text-lg text-slate-500">
              AI-powered validation of your requirements against best practices
            </p>
          </div>
          {/* Stats Cards */}
      ...
      <div
        className={
          hideMetrics
            ? ""
            : "bg-white/80 rounded-3xl shadow-2xl p-10 animate-fadeIn mt-10"
        }
      >
