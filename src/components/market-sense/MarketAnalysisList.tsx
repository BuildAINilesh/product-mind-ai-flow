          ...
          <Card key={analysis.id} className="overflow-hidden">
            <CardHeader className="pb-2">
              <div className="flex justify-between items-center">
                <div>
                  <CardTitle className="text-base">{analysis.requirements?.project_name || 'Unknown Project'}</CardTitle>
                  <CardDescription className="text-xs">{analysis.requirements?.req_id || 'N/A'}</CardDescription>
                </div>
            ...
            <CardContent className="pb-4">
              <div className="flex flex-col space-y-3">
                <div className="grid grid-cols-2 text-sm">
                  ...
                  <span>{analysis.requirements?.industry_type || 'N/A'}</span>
                </div>
                <div className="grid grid-cols-2 text-sm">
