    ...
    <div className="min-h-screen flex flex-col">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-lg md:text-xl mb-8 text-foreground/80 max-w-2xl mx-auto lg:mx-0">
                Transform your product development lifecycle with AI networks
                and machine learning assistance at every stage, from ideation to
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">
              Supercharge Your Product Development with{" "}
              <AIGradientText>AI</AIGradientText>
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Our AI-powered platform streamlines every stage of the product
              lifecycle with intelligent assistance and AI networks.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="ai-card card-hover overflow-hidden border-border/50"
              >
      ...
      <section className="py-16 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">
              How <AIGradientText>ProductMind AI</AIGradientText> Works
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Our AI-driven workflow helps product teams move from idea to
              approved requirements with machine learning assistance.
            </p>
          </div>
      ...
      <footer className="py-12 px-4 bg-muted">
        <div className="container mx-auto">
          ...
          <div className="mt-12 pt-8 border-t border-border text-center text-muted-foreground">
            <p>
              &copy; {new Date().getFullYear()} ProductMind. All rights
              reserved.
            </p>
          </div>
        </div>
...
const features = [
  {
    ...
    description:
      "Transform ideas into structured requirements with AI assistance that identifies gaps and enhances quality.",
    icon: <Brain size={24} className="text-primary" />,
  },
  {
    title: "MarketSense AI",
    description:
      "Get real-time market insights, competitor analysis, and gap identification powered by AI networks.",
    icon: <BarChart3 size={24} className="text-primary" />,
  },
  {
    title: "AI TestGen",
    description:
      "Automatically generate comprehensive test cases and scenarios based on requirement analysis.",
    icon: <FileCheck size={24} className="text-primary" />,
  },
  {
    title: "BugShield ML",
    description:
      "Predict potential defects and issues before they occur with our AI risk analysis algorithms.",
    icon: <Layers size={24} className="text-primary" />,
  },
  {
    title: "AI Signoff",
    description:
      "Streamline approvals with AI recommendations and automated validation of requirements.",
    icon: <CheckCircle size={24} className="text-primary" />,
  },
  {
    title: "AI Analytics",
    description:
      "Create comprehensive reports with visualizations and insights from your product development process.",
...
const steps = [
  {
    ...
    description:
      "Input your product ideas and let AI networks structure them into formal requirements.",
  },
  {
    title: "Machine Learning Analysis",
    description:
      "Receive AI-powered market insights and competitive analysis for your requirements.",
  },
  {
    title: "AI Test Generation",
    description:
      "Generate comprehensive test cases to validate your requirements using AI models.",
  },
  {
    title: "AI-Powered Approval",
    description:
      "Get intelligent validation and streamlined approval for your product requirements.",
  },
];
